Invalid depfile: C:\Users\footlong\ai_fitness_coach.dart_tool\flutter_build\d9b48e8b548355d456a4e86ba0ac10fd\kernel_snapshot_program.d
Invalid depfile: C:\Users\footlong\ai_fitness_coach.dart_tool\flutter_build\d9b48e8b548355d456a4e86ba0ac10fd\kernel_snapshot_program.d
Invalid depfile: C:\Users\footlong\ai_fitness_coach.dart_tool\flutter_build\d9b48e8b548355d456a4e86ba0ac10fd\kernel_snapshot_program.d
Invalid depfile: C:\Users\footlong\ai_fitness_coach.dart_tool\flutter_build\d9b48e8b548355d456a4e86ba0ac10fd\kernel_snapshot_program.d
...
class _SplashScreenState extends State {
^^^^^^^^^^^^^^^^^^
lib/main.dart:3:8: Error: Not found: 'package:hive_flutter/hive_flutter.dart'
import 'package:hive_flutter/hive_flutter.dart';
^
lib/main.dart:25:8: Error: Not found: 'package:hive_flutter/hive_flutter.dart'
import 'package:hive_flutter/hive_flutter.dart';
^
...
^
lib/domain/models/workout_program.dart:1:8: Error: Not found: 'package:equatable/equatable.dart'
import 'package:equatable/equatable.dart';
^
lib/domain/models/athlete_profile.dart:1:8: Error: Not found: 'package:equatable/equatable.dart'
import 'package:equatable/equatable.dart';
^
...
List _generateSampleWeeks(int weekCount,
^^^^^^^^^^^
lib/features/program_selection/program_selection_screen.dart:122:8: Error: Type 'DailyWorkout' not found.
List _generateSampleDays() {
^^^^^^^^^^^^
lib/domain/models/workout_program.dart:7:30: Error: Type 'Equatable' not found.
...
^^^^^^^^^^^
lib/domain/models/athlete_profile.dart:7:30: Error: Type 'Equatable' not found.
class AthleteProfile extends Equatable {
^^^^^^^^^
lib/domain/models/athlete_profile.dart:356:25: Error: Type 'Equatable' not found.
class WeakPoint extends Equatable {
^^^^^^^^^
lib/domain/models/athlete_profile.dart:391:22: Error: Type 'Equatable' not found.
class Injury extends Equatable {
^^^^^^^^^
lib/main.dart:55:9: Error: Undefined name 'Hive'.
await Hive.initFlutter();
^^^^
lib/main.dart:58:28: Error: Undefined name 'Hive'.
final workoutBox = await Hive.openBox('workouts');
^^^^
lib/main.dart:59:28: Error: Undefined name 'Hive'.
final programBox = await Hive.openBox('programs');
^^^^
lib/main.dart:60:28: Error: Undefined name 'Hive'.
final profileBox = await Hive.openBox('profiles');
^^^^
lib/main.dart:61:28: Error: Undefined name 'Hive'.
...
Errors #1 asFileUri (package:vm/kernel_front_end.dart:792)